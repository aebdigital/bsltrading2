...
export const referenceProjects: ReferenceProject[] = [
  {
    ...
    coverImage: "/BD_Humenne_Hrnciarska/68a24c09-9cdf-465a-a235-fe482dff9c72.JPG",
    gallery: [
      { src: "/BD_Humenne_Hrnciarska/68a24c09-9cdf-465a-a235-fe482dff9c72.JPG", alt: "Bytový dom Hrnčiarska - zrekonštruovaný objekt" },
      { src: "/BD_Humenne_Hrnciarska/0ef7e5d0-c993-45dc-a047-256c4df3eadf.JPG", alt: "Bytový dom Hrnčiarska - pohľad na fasádu" },
      { src: "/BD_Humenne_Hrnciarska/3dc1680f-14c2-4fe6-b8c0-4af12a24dcb0.JPG", alt: "Bytový dom Hrnčiarska - detail vchodu" },
      { src: "/BD_Humenne_Hrnciarska/59fc64a6-249a-46ba-8b96-d6cafebffd98.JPG", alt: "Bytový dom Hrnčiarska - zatepľovacie práce" },
      { src: "/BD_Humenne_Hrnciarska/718231de-000f-4326-9e13-2711bba935f4.JPG", alt: "Bytový dom Hrnčiarska - pohľad zo zadnej strany" },
      { src: "/BD_Humenne_Hrnciarska/74f754c0-f0ab-401a-b79c-22c45a4a1b5b.JPG", alt: "Bytový dom Hrnčiarska - detail balkónov" },
      { src: "/BD_Humenne_Hrnciarska/9abcb430-449a-4eea-9117-7056fab8bf0c.JPG", alt: "Bytový dom Hrnčiarska - dokončená fasáda" },
      { src: "/BD_Humenne_Hrnciarska/ab362735-7e60-4241-bfe7-0dd1fca9edbe.JPG", alt: "Bytový dom Hrnčiarska - pohľad z boku" },
      { src: "/BD_Humenne_Hrnciarska/ac38c2fe-01b2-48b8-b2e9-a5ba29253723.JPG", alt: "Bytový dom Hrnčiarska - celkový pohľad" },
      { src: "/BD_Humenne_Hrnciarska/bb8814b6-6547-476c-b6a4-9afd5804bafc.JPG", alt: "Bytový dom Hrnčiarska - rekonštrukcia sokla" },
      { src: "/BD_Humenne_Hrnciarska/dba18922-48cc-4e45-a85b-84c271700c5d.JPG", alt: "Bytový dom Hrnčiarska - detailný pohľad na roh" },
      { src: "/BD_Humenne_Hrnciarska/f492a02d-eaa5-46c2-a855-13deefe3971a.JPG", alt: "Bytový dom Hrnčiarska - zrekonštruované priečelie" }
    ],
    featured: true
  },
  {
    ...
    coverImage: "/Bytovy_dom_strazske/a57276fd-fff1-4a44-81be-95dba500e0b0.JPG",
    gallery: [
      { src: "/Bytovy_dom_strazske/a57276fd-fff1-4a44-81be-95dba500e0b0.JPG", alt: "Bytový dom Strážske - hotová fasáda" },
      { src: "/Bytovy_dom_strazske/4092b5a5-34f6-4a60-a284-2afccc924b20.JPG", alt: "Bytový dom Strážske - stavebné úpravy" },
      { src: "/Bytovy_dom_strazske/42291892-0eb3-4162-bca3-c72443828649.JPG", alt: "Bytový dom Strážske - priebeh rekonštrukcie" },
      { src: "/Bytovy_dom_strazske/43a99c7f-eb44-41bd-86f8-753e259c9d6a.JPG", alt: "Bytový dom Strážske - dokončovanie interiéru" },
      { src: "/Bytovy_dom_strazske/553ff555-3e92-4079-9bf1-dcda7f648cf3.JPG", alt: "Bytový dom Strážske - omietkárske práce" },
      { src: "/Bytovy_dom_strazske/72fb2c8c-010a-44b3-b173-c5bc118a6aee.JPG", alt: "Bytový dom Strážske - pohľad z ulice" },
      { src: "/Bytovy_dom_strazske/7ab2b463-f2dd-48e3-885a-cf9f1d6c984c.JPG", alt: "Bytový dom Strážske - nová fasáda" },
      { src: "/Bytovy_dom_strazske/80886eb0-feed-4bd3-9ca7-b17b48458cff.JPG", alt: "Bytový dom Strážske - zrekonštruovaný objekt" },
      { src: "/Bytovy_dom_strazske/867b1c79-7769-4d50-a1cd-006c595e703e.JPG", alt: "Bytový dom Strážske - rekonštrukcia vchodu" },
      { src: "/Bytovy_dom_strazske/c4a35355-108b-47b9-bdab-18ac4e50950b.JPG", alt: "Bytový dom Strážske - modernizovaný vzhľad" },
      { src: "/Bytovy_dom_strazske/d6ed5827-2898-4617-917d-3cc43128d0f1.JPG", alt: "Bytový dom Strážske - zatepľovanie" },
      { src: "/Bytovy_dom_strazske/ec02c7c1-bc79-4451-9729-57e404e5d34f.JPG", alt: "Bytový dom Strážske - pohľad z bočnej strany" },
      { src: "/Bytovy_dom_strazske/faea43ae-b416-4422-aeae-92d4b11d50eb.JPG", alt: "Bytový dom Strážske - hotová realizácia" }
    ],
    featured: true
  },
  {
    ...
    coverImage: "/Mestsky_Urad_Humenne/cd0599b8-d201-495f-8100-579f5ddc52b7.JPG",
    gallery: [
      { src: "/Mestsky_Urad_Humenne/cd0599b8-d201-495f-8100-579f5ddc52b7.JPG", alt: "Mestský úrad Humenné - celkový pohľad po modernizácii" },
      { src: "/Mestsky_Urad_Humenne/12ca1d6b-12d8-46d5-aee2-624aafa79155.JPG", alt: "Mestský úrad Humenné - rekonštrukcia interiéru" },
      { src: "/Mestsky_Urad_Humenne/15e5800b-6b44-41b2-ade0-bfc814419daf.JPG", alt: "Mestský úrad Humenné - stavebné úpravy chodieb" },
      { src: "/Mestsky_Urad_Humenne/16650a54-a18e-4a5b-9505-eec0a8f6615c.JPG", alt: "Mestský úrad Humenné - pokládka dlažby" },
      { src: "/Mestsky_Urad_Humenne/31c73bfe-835f-4294-a7fa-78e4906625af.JPG", alt: "Mestský úrad Humenné - omietky a stierky" },
      { src: "/Mestsky_Urad_Humenne/330fa93c-5ebd-45bb-87be-7dbe91be8357.JPG", alt: "Mestský úrad Humenné - montáž sadrokartónov" },
      { src: "/Mestsky_Urad_Humenne/3d13d233-4422-4578-ac27-3aeb7d68bc09.JPG", alt: "Mestský úrad Humenné - práce na vnútornej inštalácii" },
      { src: "/Mestsky_Urad_Humenne/4dcac7a3-5722-4225-b691-6e867100fb9d.JPG", alt: "Mestský úrad Humenné - modernizovaná kancelária" },
      { src: "/Mestsky_Urad_Humenne/73c97754-713b-41ff-a724-85d853a8a732.JPG", alt: "Mestský úrad Humenné - dokončené priestory" },
      { src: "/Mestsky_Urad_Humenne/8cadf14b-6f73-40eb-865d-cb701b76dd1b.JPG", alt: "Mestský úrad Humenné - rekonštrukcia vchodu" },
      { src: "/Mestsky_Urad_Humenne/968e5c7f-9e42-46f9-8237-5701e4ff601a.JPG", alt: "Mestský úrad Humenné - detaily obkladov" },
      { src: "/Mestsky_Urad_Humenne/b610bbfe-fb77-4500-a0a3-0806b72dd98b.JPG", alt: "Mestský úrad Humenné - obnova stien" },
      { src: "/Mestsky_Urad_Humenne/bee4818e-513d-4ab8-9b6f-92663428f70b.JPG", alt: "Mestský úrad Humenné - stavebné detaily" }
    ],
    featured: true
  },
  {
    ...
    coverImage: "/Predajna_CBA_Kamenak/3d7969de-7e48-4a56-905d-e7bc89cb039d.JPG",
    gallery: [
      { src: "/Predajna_CBA_Kamenak/3d7969de-7e48-4a56-905d-e7bc89cb039d.JPG", alt: "CBA Kameňák - omietky v skladoch" },
      { src: "/Predajna_CBA_Kamenak/00053d76-8b9a-412d-88ff-4aa3b3afea73.JPG", alt: "CBA Kameňák - stavebná pripravenosť" },
      { src: "/Predajna_CBA_Kamenak/12a1daac-f58c-4309-bad6-697604329fc1.JPG", alt: "CBA Kameňák - búracie práce a príprava" },
      { src: "/Predajna_CBA_Kamenak/33354b69-6552-4b1e-a3e3-10b7e8a1a009.JPG", alt: "CBA Kameňák - realizácia interiéru" },
      { src: "/Predajna_CBA_Kamenak/38c07ae1-004d-4bbe-b93c-63fdbc6d6896.JPG", alt: "CBA Kameňák - potery a podlahy" },
      { src: "/Predajna_CBA_Kamenak/3c6dc5fb-e997-42ae-9259-e46aaee0aa14.JPG", alt: "CBA Kameňák - elektroinštalácia" },
      { src: "/Predajna_CBA_Kamenak/5b789f68-13a6-47ec-96c5-c818cafd7276.JPG", alt: "CBA Kameňák - zateplenie fasády" },
      { src: "/Predajna_CBA_Kamenak/625aef04-4432-4490-ad43-369ca65cc720.JPG", alt: "CBA Kameňák - príprava spevnených plôch" },
      { src: "/Predajna_CBA_Kamenak/6b09d406-ba5d-4bb3-a770-1475f8a11bae.JPG", alt: "CBA Kameňák - oplotenie a okolie" },
      { src: "/Predajna_CBA_Kamenak/704683c3-d8a0-408c-a6cc-1d766866e616.JPG", alt: "CBA Kameňák - dokončovacie interiérové detaily" },
      { src: "/Predajna_CBA_Kamenak/b9831e1e-785b-4b81-8514-6610e0953409.JPG", alt: "CBA Kameňák - hotová prevádzka" },
      { src: "/Predajna_CBA_Kamenak/c1e2027b-8f3e-45bb-ad86-1f9d97a8825f.JPG", alt: "CBA Kameňák - spevnená plocha a parking" },
      { src: "/Predajna_CBA_Kamenak/ce179066-737e-4f51-8f01-3dc05299e38f.JPG", alt: "CBA Kameňák - celkový exteriér" }
    ],
    featured: true
  },
  {
    ...
    coverImage: "/RD_Humenne_Dubnik/fd1fd40c-2d9f-4063-ad50-a6a16b42e75b.JPG",
    gallery: [
      { src: "/RD_Humenne_Dubnik/fd1fd40c-2d9f-4063-ad50-a6a16b42e75b.JPG", alt: "RD Dubník - priebeh stavebných prác" },
      { src: "/RD_Humenne_Dubnik/3c0a394e-90b5-4916-a206-5e2ab540f743.JPG", alt: "RD Dubník - stavebný pozemok a výkopy" },
      { src: "/RD_Humenne_Dubnik/cd333ad4-4477-409e-9650-9afe8969f610.JPG", alt: "RD Dubník - murovanie hrubej stavby" }
    ],
    featured: true
  }
];
